                            ...
                            <div className="row">
                                <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-7 col-sm-7">
                                    <div className="footer_widget footer_about mb-50">
                                        ...
                                        <p className="mb-30">Eaque ipsa quae ab illo inventore veris
                                        ...
                                        <div className="footer_social_2">
                                            ...
                                            <a href="#" className="behance"><i className="fab fa-behance" /></a>
                                    ...
                                    <div className="footer_widget mb-50 pl_25">
                                        ...
                                        <div className="footer_links footer_links_2">
                                            <ul>
                                                ...
                                                <li><a href="donation.html">Donation List</a></li>
                                                <li><a href="cause.html">Recent Causes</a></li>
                                                <li><a href="faq.html">FAQ</a></li>
                                            </ul>
                                        </div>
                                        <div className="footer_btn">
                                            <a href="about.html" className="g_btn fbtn_2 to_right1 p-40 rad-50">Get Support<span /></a>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-5 col-sm-5">
                                    <div className="footer_widget footer_news mb-50">
                                        ...
                                        <div className="footer_info_content">
                                            ...
                                            <p><a href="#"><span><strong>Email :</strong><span className="__cf_email__" data-cfemail="147d7a727b54516c75796478713a777b79">[email&nbsp;protected]</span></span></a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="col-xxl-6 col-xl-6 col-lg-6 col-sm-12">
                                    <div className="fcta_sigle has_bg mb-30">
                                        ...
                                        <div className="fcta_button">
                                            <a href="donation.html" className="g_btn fca_btn1 to_right2 p-40 rad-50">Donate <span /></a>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-xxl-6 col-xl-6 col-lg-6 col-sm-12">
                                    <div className="fcta_sigle has_bg pad_170s mb-30">
                                        ...
                                        <div className="fcta_button">
                                            <a href="about.html" className="g_btn fca_btn to_left p-40 rad-50">Join <span /></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
