                  ...
                  <div className="top_mailing">
                    <a href="#" className="theme-1">
                      ...
                      <span
                        ...
                        data-cfemail="e687828b8f88a682898b878f88c885898b"
                      >
                        [email&nbsp;protected]
                      </span>
                    </a>
          ...
          <div className="side-info">
            ...
            <div className="contact-infos mt-30 mb-30">
              <div className="contact-list mobile_contact mb-30">
                ...
                <a
                  href="https://wphix.com/cdn-cgi/l/email-protection#d0b1b4bdb9be90b4bfbdb1b9befeb3bfbd"
                  className="theme-3"
                >
          ...
          <div className="offset-sidebar side-info">
            ...
            <div className="contact-infos mt-30 mb-30">
              <div className="contact-list mb-30">
                ...
                <a
                  href="https://wphix.com/cdn-cgi/l/email-protection#2140454c484f61454e4c40484f0f424e4c"
                  className="theme-3"
                >
                  <i className="far fa-envelope" />
                  <span>
                    <span
                      className="__cf_email__"
                      data-cfemail="f293969f9b9cb2969d9f939b9cdc919d9f"
                    >
                      [email&nbsp;protected]
                    </span>
                  </span>
