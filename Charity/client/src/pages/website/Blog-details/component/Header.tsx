                  ...
                  <div className="top_mailing">
                    <a href="#" className="theme-1">
                      ...
                      <span
                        ...
                        data-cfemail="b2d3d6dfdbdcf2d6dddfd3dbdc9cd1dddf"
                      >
                        [email&nbsp;protected]
                      </span>
                    </a>
              ...
              <div className="contact-list mobile_contact mb-30">
                ...
                >
                  ...
                  <span>
                    <span
                      className="__cf_email__"
                      data-cfemail="2342474e4a4d63474c4e424a4d0d404c4e"
                    >
                      [email&nbsp;protected]
                    </span>
                  </span>
          ...
          <div className="offset-sidebar side-info">
            ...
            <div className="contact-infos mt-30 mb-30">
              <div className="contact-list mb-30">
                ...
                <a
                  href="https://wphix.com/cdn-cgi/l/email-protection#4a2b2e2723240a2e25272b232464292527"
                  className="theme-3"
                >
                  <i className="far fa-envelope" />
                  <span>
                    <span
                      className="__cf_email__"
                      data-cfemail="3756535a5e597753585a565e591954585a"
                    >
                      [email&nbsp;protected]
                    </span>
                  </span>
