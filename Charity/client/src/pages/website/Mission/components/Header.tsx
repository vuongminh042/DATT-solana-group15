                            ...
                            <div className="row align-items-center">
                                <div className="col-xxl-9 col-xl-9 col-lg-8">
                                    <div className="top_mailing">
                                        <a href="#" className="theme-1"><i className="fal fa-envelope" /><span className="__cf_email__" data-cfemail="cdaca9a0a4a38da9a2a0aca4a3e3aea2a0">[email&nbsp;protected]</span></a>
                    ...
                    <div className="side-info">
                        ...
                        <div className="contact-infos mt-30 mb-30">
                            <div className="contact-list mobile_contact mb-30">
                                ...
                                <a href="https://wphix.com/cdn-cgi/l/email-protection#6001040d090e20040f0d01090e4e030f0d" className="theme-3"><i className="far fa-envelope" /><span><span className="__cf_email__" data-cfemail="2041444d494e60444f4d41494e0e434f4d">[email&nbsp;protected]</span></span></a>
                            </div>
                    ...
                    <div className="offset-sidebar side-info">
                        ...
                        <div className="contact-infos mt-30 mb-30">
                            <div className="contact-list mb-30">
                                ...
                                <a href="#" className="theme-1"><i className="fal fa-map-marker-alt" /><span>12/A, Mirnada City Tower, NYC</span></a>
                                <a href="tel:088889797697" className="theme-2"><i className="fal fa-phone" /><span>088889797697</span></a>
                                <a href="https://wphix.com/cdn-cgi/l/email-protection#9dfcf9f0f4f3ddf9f2f0fcf4f3b3fef2f0" className="theme-3"><i className="far fa-envelope" /><span><span className="__cf_email__" data-cfemail="a2c3c6cfcbcce2c6cdcfc3cbcc8cc1cdcf">[email&nbsp;protected]</span></span></a>
                            </div>
                            <div className="top_social offset_social mt-20 mb-30">
                                <a href="#" target="_blank" className="facebook"><i className="fab fa-facebook-f" /></a>
                                <a href="#" target="_blank" className="twitter"><i className="fab fa-twitter" /></a>
