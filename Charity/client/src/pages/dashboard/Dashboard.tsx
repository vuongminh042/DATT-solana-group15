...
const items2: MenuProps["items"] = [
  {
    ...
    children: [{ key: "5", label: <Link to="user-list">User List</Link> }],
  },
  {
    key: "sub4",
  ...
  {
    key: "sub6",
    icon: <AppstoreOutlined />, // Icon for Category
    label: "Cause Management",
    children: [
  ...
  return (
    <Layout>
      ...
      <Footer style={{ textAlign: "center" }}>
        Charity Dashboard ©{new Date().getFullYear()} Created for Charity
        Management
      </Footer>
    </Layout>
  );
